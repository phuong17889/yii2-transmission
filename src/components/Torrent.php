 ...
 * $torrent->announce(array('http://torrent.tracker/annonce', 'http://alternate-torrent.tracker/annonce')); // set
 * tracker(s), it also works with a 'one tracker' array...
 * $torrent->announce(array(array('http://torrent.tracker/annonce', 'http://alternate-torrent.tracker/annonce'),
 * 'http://another-torrent.tracker/annonce')); // set tiered trackers
 ...
 * @property $httpseeds
 */
class Torrent extends \Transmission\Model\Torrent {
